...
# from future import standard_library  # Incompatible with Python 3.12+

# python 2 compatibility:
if 'xrange' not in dir(__builtins__):
    # from future import standard_library  # Incompatible with Python 3.12+
    # from future.utils import string_types  # Incompatible with Python 3.12+

    # standard_library.install_aliases()  # Incompatible with Python 3.12+
